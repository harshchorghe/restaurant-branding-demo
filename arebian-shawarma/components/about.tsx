...
export default function About() {
  return (
    <section id="about" className="relative py-8 md:py-24 bg-brand-primary px-6 md:px-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h2 className="font-playfair text-2xl md:text-5xl font-black text-brand-white uppercase leading-tight">
              A Legacy of <br />
              <span className="text-gold-gradient gold-text-glow">Authentic Spices</span>
            </h2>
            <div className="w-16 h-[2px] bg-brand-gold mt-3 md:mt-4 mb-4 md:mb-8 mx-auto lg:mx-0" />
            
            <p className="font-poppins text-brand-muted text-xs md:text-base leading-relaxed mb-4 md:mb-6">
            ...
            <p className="font-poppins text-brand-muted text-xs md:text-base leading-relaxed mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 w-full">
              <div className="flex flex-col items-center text-center sm:items-start sm:text-left p-3.5 md:p-4 bg-brand-secondary/40 border border-brand-gold/10 rounded-2xl">
                <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-brand-gold mb-1.5 md:mb-2" />
                <h4 className="font-playfair text-xs md:text-sm font-bold text-brand-white">100% Organic</h4>
                <span className="font-poppins text-[9px] md:text-[10px] text-brand-muted mt-1">Authentic imported spices.</span>
              </div>
              <div className="flex flex-col items-center text-center sm:items-start sm:text-left p-3.5 md:p-4 bg-brand-secondary/40 border border-brand-gold/10 rounded-2xl">
                <Compass className="w-4 h-4 md:w-5 md:h-5 text-brand-gold mb-1.5 md:mb-2" />
                <h4 className="font-playfair text-xs md:text-sm font-bold text-brand-white">Hand Crafted</h4>
                <span className="font-poppins text-[9px] md:text-[10px] text-brand-muted mt-1">Layered spit daily.</span>
              </div>
              <div className="flex flex-col items-center text-center sm:items-start sm:text-left p-3.5 md:p-4 bg-brand-secondary/40 border border-brand-gold/10 rounded-2xl">
                <Heart className="w-4 h-4 md:w-5 md:h-5 text-brand-gold mb-1.5 md:mb-2" />
                <h4 className="font-playfair text-xs md:text-sm font-bold text-brand-white">Smoky Flavor</h4>
                <span className="font-poppins text-[9px] md:text-[10px] text-brand-muted mt-1">Slow charcoal roasted.</span>
              </div>
            </div>
          </div>
