    ...
    <section className="relative py-8 md:py-24 bg-brand-primary px-6 md:px-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative h-[200px] md:h-[450px] rounded-3xl overflow-hidden shadow-2xl group border border-brand-gold/20">
            ...
            />
            {/* Overlay Banner */}
            <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 z-20 bg-brand-primary/95 backdrop-blur-md border border-brand-gold/30 px-4 py-2.5 md:px-5 md:py-3 rounded-2xl">
              <span className="font-montserrat text-[8px] md:text-[10px] tracking-[0.25em] font-semibold text-brand-gold uppercase block">Freshly Grilled</span>
              <span className="font-playfair text-base md:text-xl font-extrabold text-brand-white uppercase mt-1 block">Family Platter</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 md:px-4 md:py-2 rounded-full bg-brand-gold/10 border border-brand-gold/30 mb-4 md:mb-6"
            >
              <Gift className="w-3.5 h-3.5 text-brand-gold" />
              <span className="font-montserrat text-[8px] md:text-[10px] tracking-[0.2em] font-bold text-brand-gold uppercase">
            ...
            <motion.h2
              ...
              className="font-playfair text-2xl md:text-5xl font-black text-brand-white uppercase leading-tight"
            >
              Friday <br />
            ...
            <motion.p
              ...
              className="font-poppins text-brand-muted text-xs md:text-base mt-3 md:mt-6 leading-relaxed"
            >
            ...
            <motion.div
              ...
              className="glass-card rounded-2xl p-4 md:p-6 border-brand-gold/30 flex flex-col sm:flex-row items-center gap-4 md:gap-6 mt-4 md:mt-8 w-full max-w-lg mx-auto lg:mx-0"
            >
              <div className="flex-1 text-center sm:text-left">
                <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.25em] text-brand-cream block mb-1">Coupon Code</span>
                <span className="font-playfair text-xl md:text-3xl font-black text-brand-white tracking-wider block">SHAWARMA50</span>
              </div>
